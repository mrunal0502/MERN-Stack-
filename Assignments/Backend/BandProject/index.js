...
app.get("/", (req, res) => {
  ...
  res.render("index", { htmlContext: null });
});
...
app.post("/submit", (req, res) => {
  ...
  var adjRan = adj[Math.floor(Math.random() * adj.length)];
  var nounRan = noun[Math.floor(Math.random() * noun.length)];
  //2. Send the index.ejs as a response and add the adjective and noun to the res.render
  res.render("index", { htmlContext: adjRan + " " + nounRan });
